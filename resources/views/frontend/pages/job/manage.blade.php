                            ...
                            <div class="mng-resume">
                                ...
                                <div class="col-md-1 col-sm-1 pull-right">
                                    <div class="mng-resume-action">
                                        <a href="{{route('edit.job',['id' => $job->id])}}" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                        <a href="{{route('delete.job',['id' => $job->id])}}" onclick="return confirm('Are you sure?')" data-toggle="tooltip" title="Delete"><i class="fa fa-trash-o"></i></a>
                                    </div>
                                </div>
